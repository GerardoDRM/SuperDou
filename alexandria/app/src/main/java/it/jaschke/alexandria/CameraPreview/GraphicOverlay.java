...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public void setTrigger(FloatingActionButton floatingActionButton) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        synchronized (mLock) {
            ...
            if(mFirstGraphic != null) {
                // Change status on UI
                mFloating.setColorFilter(0xffffffff, PorterDuff.Mode.MULTIPLY);
                mFirstGraphic.draw(canvas);
            }
            else {
                mFloating.setColorFilter(0xff444444, PorterDuff.Mode.MULTIPLY);
            }
        }
    }
}
